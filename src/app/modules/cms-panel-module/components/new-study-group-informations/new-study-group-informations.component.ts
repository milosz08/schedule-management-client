 ...
 *
 * File name | Nazwa pliku: new-study-group-informations.component.ts
...
@Component({
    selector: 'app-new-study-group-informations',
    templateUrl: './new-study-group-informations.component.html',
    styleUrls: [],
})
export class NewStudyGroupInformationsComponent implements OnInit, OnDestroy {
