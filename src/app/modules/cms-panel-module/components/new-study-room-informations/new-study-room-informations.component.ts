 ...
 *
 * File name | Nazwa pliku: new-study-room-informations.component.ts
...
@Component({
    selector: 'app-new-study-room-informations',
    templateUrl: './new-study-room-informations.component.html',
    styleUrls: [],
})
export class NewStudyRoomInformationsComponent implements OnInit, OnDestroy {
