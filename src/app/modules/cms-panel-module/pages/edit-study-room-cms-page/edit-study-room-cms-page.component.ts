 ...
 *
 * File name | Nazwa pliku: edit-study-room-cms-page.component.ts
...
/**
 * Komponent odpowiedzialny za możliwość edycji wybranej sali zajęciowej (na podstawie parametru ścieżki URL).
 */

@Component({
    selector: 'app-edit-study-room-cms-page',
    templateUrl: './edit-study-room-cms-page.component.html',
    styleUrls: [],
