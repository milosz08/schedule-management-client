...
export class ApiConfigurerHelper {
    ...
    public readonly DELETE_CONTACT_MESSAGES = ApiConfigurerHelper.API_PREFIX + 'contactmessages/delete';
    public readonly ADD_NEW_CONTACT_MESSAGE = ApiConfigurerHelper.API_PREFIX + 'contactmessages/add-contact-message';
    public readonly MASSIVE_DELETE_CONTACT_MESSAGES = ApiConfigurerHelper.API_PREFIX + 'contactmessages/delete-massive';
    public readonly GET_MESSAGE_BASE_ID_AND_CLAIMS = ApiConfigurerHelper.API_PREFIX + 'contactmessages/message-base-id-and-claim';
    ...
    public readonly CMS_FILTERED_ALL_USER_MESSAGES_BASE_CLAIMS = ApiConfigurerHelper.API_PREFIX + 'contactmessages/all-messages-base-user-claim';
